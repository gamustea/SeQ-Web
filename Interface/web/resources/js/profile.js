...
async function updateProfile(formData) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            throw new Error(
                error.error_description || "Error al actualizar el perfil",
            );
        }
...
async function changePassword(currentPassword, newPassword) {
    ...
    try {
        ...
        if (!response.ok) {
            const error = await response.json();
            throw new Error(
                error.error_description || "Error al cambiar la contraseña",
            );
        }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    passwordForm?.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            passwordForm.reset();
            showToast(
                "Contraseña cambiada correctamente. Inicie sesión de nuevo.",
                "success",
            );
            setTimeout(() => {
                sessionStorage.removeItem("seq_session");
