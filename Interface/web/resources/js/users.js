...
async function loadUsers() {
    ...
    for (var j = 0; j < users.length; j++) {
        ...
        users[j]._attributes = users[j].attributes || [];
    }
...
function buildAttributeSection(attributes, isAdminOrRoot) {
    ...
    var addBtn = isAdminOrRoot ? '<button class="btn btn--ghost btn--sm" id="btn-add-attr">+ A&ntilde;adir atributo</button>' : "";
